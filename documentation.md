...
-   **author**: \[John Keltz](mailto&#x3A;jdkeltz@atlanta.k12.ga.us)
...
This function recieves the bar graph array and outputs the color array. It calls dataColor to build the color array.
...
-   `colors` **[array][20]** List of hex colors for bar graph. Usually generated by @see [colorArray][3] or a similar function.
